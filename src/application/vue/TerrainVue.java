		...
		for(int i = 0; i < terrain.getMap().length; i++){
			for(int j=0 ; j <terrain.getMap()[i].length; j++) {
				...
				case 4: 
					...
					Rectangle2D tuile4 = new Rectangle2D(4*64,0*64,64,64);		 		
